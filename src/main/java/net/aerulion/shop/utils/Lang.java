...
public class Lang {
  ...
  public static final String ERROR_MAX_STACK_AMOUNT =
  ...
  public static final String ERROR_INVENTORY_FULL =
      CHAT_PREFIX + "§cDu hast nicht genug Platz im Inventar";
  public static final String ERROR_TRANSACTION_FAILED =
  ...
  public static final String ERROR_NO_COMMAND_PERMISSION =
      CHAT_PREFIX + "§cDu hast keine Rechte diesen Befehl zu nutzen.";
  public static final String ERROR_NO_SHOP_PERMISSION =
  ...
  public static final String ERROR_NUMBER_TOO_SMALL =
  ...
  public static final String ERROR_NO_ITEM_IN_HAND =
  ...
  public static final String ERROR_WRONG_QUESTION_ANSWER =
      CHAT_PREFIX + "§cDas eingegebene Passwort ist nicht korrekt.";
  public static final String ERROR_PLAYER_NOT_FOUND =
  ...
  public static final String ERROR_SPAWNING_PARTICLE = CHAT_PREFIX
  ...
  public static final String COMMAND_ADDED =
      CHAT_PREFIX + "Folgender Befehl wurde hinzugefügt: §e/";
  public static final String ALL_COMMANDS_DELETED =
      CHAT_PREFIX + "Alle Befehle wurden vom Shop gelöscht.";
  public static final String ALL_PLAYERDATA_DELETED =
  ...
  public static final String QUESTION_RESET =
