...
public class Lang {
  ...
  public static final @NotNull String ERROR_NOT_ENOUGH_MONEY =
      CHAT_PREFIX + "§cDu hast nicht genug Geld.";
  public static final @NotNull String ERROR_INVENTORY_FULL =
      CHAT_PREFIX + "§cDu hast nicht genug Platz im Inventar";
  ...
  public static final @NotNull String ERROR_NUMBER_TOO_SMALL =
      CHAT_PREFIX + "§cDie Zahl kann nicht kleiner 1 sein.";
  public static final @NotNull String ERROR_INVALID_PRICE = CHAT_PREFIX + "§cKein gültiger Preis.";
  public static final @NotNull String ERROR_INVALID_BOOLEAN =
      CHAT_PREFIX + "§cKein gültiger boolean.";
  ...
  public static final @NotNull String ERROR_NO_ITEM_IN_HAND =
      CHAT_PREFIX + "§cFehler: Du hälst kein Item in der Hand.";
  public static final @NotNull String ERROR_SHOP_DISABLED =
      CHAT_PREFIX + "§cDieser Shop ist deaktiviert.";
  public static final @NotNull String ERROR_WRONG_QUESTION_ANSWER =
      CHAT_PREFIX + "§cDas eingegebene Passwort ist nicht korrekt.";
  public static final @NotNull String ERROR_PLAYER_NOT_FOUND =
      CHAT_PREFIX + "§cFehler: Spieler nicht gefunden.";
  public static final @NotNull String ERROR_SHOP_NOT_FOUND =
      CHAT_PREFIX + "§cFehler: Shop nicht gefunden.";
  ...
  public static final @NotNull String NEW_SHOP_ITEMS =
      CHAT_PREFIX + "Neue Shop Items wurden festgelegt.";
  public static final @NotNull String TOGGLED_ENABLED =
      CHAT_PREFIX + "Der Shop wurde (de-)aktiviert.";
  public static final @NotNull String NEW_LIMIT = CHAT_PREFIX + "Das neue Limit beträgt nun: ";
  public static final @NotNull String NEW_PERMISSION =
      CHAT_PREFIX + "Die neue Permission lautet: §eshop.";
  public static final @NotNull String NEW_NAME = CHAT_PREFIX + "Die neuer Name lautet: §e";
  public static final @NotNull String COMMAND_ADDED =
      CHAT_PREFIX + "Folgender Befehl wurde hinzugefügt: §e/";
  public static final @NotNull String ALL_COMMANDS_DELETED =
      CHAT_PREFIX + "Alle Befehle wurden vom Shop gelöscht.";
  ...
  public static final @NotNull String NEW_QUESTION_ANSWER =
      CHAT_PREFIX + "Die neue Antwort lautet: ";
  public static final @NotNull String QUESTION_RESET =
      CHAT_PREFIX + "Die Passwortabfrage wurde deaktiviert.";
  ...
  public static final @NotNull String CONSOLE_PLUGIN_ENABLED =
      CHAT_PREFIX + "§bDas Plugin wurde aktiviert.";
  public static final @NotNull String CONSOLE_DISABLING = CHAT_PREFIX + "§bDeaktiviere Plugin...";
  public static final @NotNull String CONSOLE_PLUGIN_DISABLED =
      CHAT_PREFIX + "§bDas Plugin wurde deaktiviert.";
